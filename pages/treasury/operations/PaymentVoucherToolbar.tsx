...
interface PaymentVoucherToolbarProps {
...
const PaymentVoucherToolbar: React.FC<PaymentVoucherToolbarProps> = ({
    selectedRowsCount,
    rowDensity,
    onNew,
    onEdit,
    ...
    return (
        <div className="mb-3 flex flex-wrap items-center gap-2 rounded-2xl border border-slate-200 bg-white/80 p-3 shadow-sm">
            <button
                type="button"
                onClick={onNew}
                className="inline-flex h-10 items-center gap-2 rounded-2xl bg-gradient-to-r from-rose-600 to-red-500 px-4 text-sm font-bold text-white shadow-lg shadow-rose-900/15 transition hover:brightness-105"
            >
                <Plus size={16} />
                <span>جديد</span>
            </button>
