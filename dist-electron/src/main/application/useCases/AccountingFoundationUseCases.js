...
class AccountingFoundationUseCases {
    ...
    async saveAccount(companyId, currentBranchId, input) {
        ...
        ChartOfAccountsPolicy_1.ChartOfAccountsPolicy.validateSubtypeByType(input.accountType, input.accountSubtype);
        const resolvedReferenceType = input.referenceType || ChartOfAccountsPolicy_1.ChartOfAccountsPolicy.defaultReferenceTypeForSubtype(input.accountSubtype);
        ChartOfAccountsPolicy_1.ChartOfAccountsPolicy.validateReferenceTypeBySubtype(input.accountSubtype, resolvedReferenceType);
