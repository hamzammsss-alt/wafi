...
exports.SalesStockLedgerService = void 0;
const errors_1 = require("../../domain/errors");
const EPSILON = 0.000001;
class SalesStockLedgerService {
    constructor(repository) {
        this.repository = repository;
    }
    postDelivery(context, header, lines) {
...
exports.SalesStockLedgerService = SalesStockLedgerService;
