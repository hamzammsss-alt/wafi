...
exports.SCREEN_DEFINITIONS = void 0;
exports.getScreenDefinition = getScreenDefinition;
exports.listScreenDefinitions = listScreenDefinitions;
const SCREEN_DEFINITION_LIST = [
    {
...
exports.SCREEN_DEFINITIONS = SCREEN_DEFINITION_LIST.reduce((acc, item) => {
    acc[item.screenKey] = item;
    return acc;
}, {});
function getScreenDefinition(screenKey) {
    return exports.SCREEN_DEFINITIONS[screenKey] || null;
}
function listScreenDefinitions() {
