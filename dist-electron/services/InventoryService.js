...
const DEFAULT_UNITS = [
    ...
    { name_ar: 'وحدة', name_en: 'Unit', code: 'UNT', symbol: 'u' },
    { name_ar: 'صندوق', name_en: 'Box', code: 'BOX', symbol: 'box' },
    { name_ar: 'كرتون', name_en: 'Carton', code: 'CTN', symbol: 'ctn' },
    { name_ar: 'عبوة', name_en: 'Package', code: 'PKG', symbol: 'pkg' },
    { name_ar: 'باكيت', name_en: 'Packet', code: 'PAC', symbol: 'pac' },
    { name_ar: 'دستة', name_en: 'Dozen', code: 'DZN', symbol: 'doz' },
    { name_ar: 'زوج', name_en: 'Pair', code: 'PR', symbol: 'pr' },
    { name_ar: 'طقم', name_en: 'Set', code: 'SET', symbol: 'set' },
    { name_ar: 'رول', name_en: 'Roll', code: 'ROL', symbol: 'rol' },
    { name_ar: 'بالة', name_en: 'Bale', code: 'BAL', symbol: 'bal' },
    { name_ar: 'طبالي', name_en: 'Pallet', code: 'PLT', symbol: 'plt' },
    { name_ar: 'كيس', name_en: 'Bag', code: 'BAG', symbol: 'bag' },
    { name_ar: 'شوال', name_en: 'Sack', code: 'SAC', symbol: 'sac' },
    { name_ar: 'علبة', name_en: 'Can', code: 'CAN', symbol: 'can' },
    { name_ar: 'زجاجة', name_en: 'Bottle', code: 'BOT', symbol: 'bot' },
    { name_ar: 'مرطبان', name_en: 'Jar', code: 'JAR', symbol: 'jar' },
    { name_ar: 'لتر', name_en: 'Liter', code: 'LTR', symbol: 'l' },
    { name_ar: 'ملليلتر', name_en: 'Milliliter', code: 'ML', symbol: 'ml' },
    { name_ar: 'جالون', name_en: 'Gallon', code: 'GAL', symbol: 'gal' },
    { name_ar: 'كيلوجرام', name_en: 'Kilogram', code: 'KG', symbol: 'kg' },
    { name_ar: 'جرام', name_en: 'Gram', code: 'GM', symbol: 'g' },
    { name_ar: 'طن', name_en: 'Ton', code: 'TON', symbol: 'ton' },
    { name_ar: 'متر', name_en: 'Meter', code: 'MTR', symbol: 'm' },
    { name_ar: 'سنتيمتر', name_en: 'Centimeter', code: 'CMT', symbol: 'cm' },
    { name_ar: 'مليمتر', name_en: 'Millimeter', code: 'MM', symbol: 'mm' },
    { name_ar: 'كيلومتر', name_en: 'Kilometer', code: 'KM', symbol: 'km' },
    { name_ar: 'قدم', name_en: 'Foot', code: 'FT', symbol: 'ft' },
    { name_ar: 'بوصة', name_en: 'Inch', code: 'IN', symbol: 'in' },
    { name_ar: 'ياردة', name_en: 'Yard', code: 'YRD', symbol: 'yd' },
    { name_ar: 'متر مربع', name_en: 'Square Meter', code: 'SQM', symbol: 'm2' },
    { name_ar: 'قدم مربع', name_en: 'Square Foot', code: 'SQF', symbol: 'ft2' },
    { name_ar: 'متر مكعب', name_en: 'Cubic Meter', code: 'CBM', symbol: 'm3' },
    { name_ar: 'قدم مكعب', name_en: 'Cubic Foot', code: 'CBF', symbol: 'ft3' },
    { name_ar: 'ساعة', name_en: 'Hour', code: 'HUR', symbol: 'hr' },
    { name_ar: 'يوم', name_en: 'Day', code: 'DAY', symbol: 'day' },
    { name_ar: 'أسبوع', name_en: 'Week', code: 'WEE', symbol: 'wk' },
    { name_ar: 'شهر', name_en: 'Month', code: 'MON', symbol: 'mo' },
    { name_ar: 'ربع سنة', name_en: 'Quarter', code: 'QTR', symbol: 'qtr' },
    { name_ar: 'سنة', name_en: 'Year', code: 'YER', symbol: 'yr' },
    { name_ar: 'لوط', name_en: 'Lot', code: 'LOT', symbol: 'lot' },
    { name_ar: 'خدمة', name_en: 'Service', code: 'SRV', symbol: 'srv' }
];
class InventoryService {
    ...
    static getUnits() {
        ...
        const units = database_1.db.prepare(`SELECT * FROM units ORDER BY ${orderBy}`).all();
