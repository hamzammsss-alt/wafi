...
const toDTO = (a: any) => ({
    ...
    supplierInvoiceAmount: a.supplierInvoiceAmount,
    clearanceCost: a.clearanceCost,
    clearanceAccountId: a.clearanceAccountId,
    purchaseJournalId: a.purchaseJournalId,
    purchaseJournalNo: a.purchaseJournalNo,
    clearanceJournalId: a.clearanceJournalId,
    clearanceJournalNo: a.clearanceJournalNo,
